...
const PropertyTypeSelection = ({ onContinue }) => {
    ...
    const typeOptions = {
        residential: [
            ...
            { value: 'retirement_apartment', label: 'Retirement Apartment' },
        ...
        agricultural: [
            ...
            { value: 'commercial_aquaculture_farm', label: 'Commercial Aquaculture Farm' },
        ...
        hospitality: [
            ...
            { value: 'four_star_b&b', label: 'Four Star B&B' },
            { value: 'four_star_beach_resort', label: 'Four Star Beach Resort' },
            { value: 'four_star_city_hotel', label: 'Four Star City Hotel' },
            { value: 'four_star_country_hotel', label: 'Four Star Country Hotel' },
            { value: 'four_star_country_resort', label: 'Four Star Country Resort' },
            { value: 'four_star_function_venue', label: 'Four Star Function Venue' },
            { value: 'four_star_game_lodge', label: 'Four Star Game Lodge' },
            { value: 'four_star_guesthouse', label: 'Four Star Guesthouse' },
