...
const BuyerVault = () => {
    ...
    return (
        <>
            ...
            >
                <BuyerHeader title="Document Vault" showNotifications={true} />
                ...
                <div className="p-4 sm:p-6 md:p-8 bg-black">
                    <div className='bg-gray-800/60 backdrop-blur-lg rounded-2xl p-4 sm:p-6 md:p-8'>
                        ...
                        {properties.map((property) => (
                            <div key={property.id} className="mb-8 bg-gray-800/60 backdrop-blur-lg rounded-2xl p-4 sm:p-6 md:p-8">
                                {/* Property Header */}
                                <div className="mb-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                                    {property.documents.map((doc) => (
                                        <div
                                            key={doc.id}
                                            className="bg-gray-700/40 backdrop-blur-lg border border-gray-600 rounded-xl p-4 sm:p-5 hover:bg-gray-700/60 transition-all duration-200 group relative"
                                        >
