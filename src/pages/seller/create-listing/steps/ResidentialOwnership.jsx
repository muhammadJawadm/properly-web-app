                ...
                {showAutoFilledData && (
                    <div className="bg-gray-600/40 backdrop-blur-lg rounded-2xl p-8">
                        ...
                        <div className="grid grid-cols-3 gap-6 mb-6">
                            <div>
                                <p className="text-gray-400 text-sm mb-1">Erf Size</p>
                                <p className="text-white font-medium">45,000 m²</p>
                            </div>
                            <div>
                                <p className="text-gray-400 text-sm mb-1">Total Hectares (for Agricultural)</p>
                                <p className="text-white font-medium">45ha</p>
                            </div>
                            <div>
                                <p className="text-gray-400 text-sm mb-1">Province</p>
                                <p className="text-white font-medium">Western Cape</p>
                            </div>
                        </div>

                        <div className="grid grid-cols-2 gap-6">
                            <div>
                                <p className="text-gray-400 text-sm mb-1">Town</p>
                                <p className="text-white font-medium">Stellenbosch</p>
                            </div>
                            <div>
                                <p className="text-gray-400 text-sm mb-1">Suburb</p>
                                <p className="text-white font-medium">Town Devon Valley</p>
                            </div>
                        </div>
